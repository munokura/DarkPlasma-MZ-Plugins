...
@plugindesc Skill/item targeting all
@author DarkPlasma
@license MIT
...
version: 1.5.0
By adding the following to the memo field of a single-target skill or item,
you can expand the scope of the target during combat.
<canExpandScope>

By adding the following, the expansion animation will be changed to n.
...
@text Overall damage multiplier
@desc Damage multiplier when all enemies are affected (%)
@type number
@default 70

@param mpCostRateForAll
@text Overall MP multiplier
@desc MP consumption multiplier when allied (%)
@type number
@default 100

@param skipTargetSelectionForAll
@text Skip all selections
@desc If ON, skips target selection for skills that originally target all.
@type boolean
@default false
*/
