...
@plugindesc Item Scene Command to discard an item
@author DarkPlasma
@license MIT
...
version: 1.1.0
When you hover the cursor over an item and press Confirm during the item
scene,
the discard command will be displayed.
...
@text Selling price 0 Disposal possibility
@desc If ON, items with a selling price of 0 can be discarded.
@type boolean
@default false
*/
