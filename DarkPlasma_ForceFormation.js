...
@plugindesc Forcefully replace with rear guard when wiped out
@author DarkPlasma
@license MIT
...
version: 2.5.0
During battle, if the frontline is wiped out, it will be forcibly replaced
with the rearline.

By adding <disableForceFormation> to the map's memo field,
forced replacement will not occur during battles on that map.
...
@desc Common event ID to execute when forcibly replacing
@type common_event
@default 0

@param forceTurnChange
@text Next turn when forced to swap
@desc Move to the next turn when forced to swap
@type boolean
@default false

@param disableSwitchId
@text Disable Switch
@desc Switch that disables forced swapping when turned ON
@type switch
@default 0
*/
