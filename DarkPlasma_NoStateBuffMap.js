// DarkPlasma_NoStateBuffMap 1.0.0
...
@plugindesc Maps that are not affected by state buffs other than incapacitation
@author DarkPlasma
@license MIT
...
version: 1.0.0
Maps marked with <noStateBuff> in the memo field
will not be affected by state buffs other than KO.

If you enter a map while already under a state or buff,
the state or buff will be removed.
*/

/*:ja
@plugindesc 戦闘不能以外のステート・バフにかからないマップ
@author DarkPlasma
@license MIT
...
@help
version: 1.0.0
メモ欄に <noStateBuff> と書かれたマップでは
戦闘不能以外のステート・バフにかかりません。

すでにステートやバフがかかった状態でそのマップに侵入した場合、
ステートやバフが解除されます。
*/
