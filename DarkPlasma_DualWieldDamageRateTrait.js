...
@plugindesc Damage multiplier characteristics of dual-wielding combo attacks
@author DarkPlasma
@license MIT
...
version: 1.0.0
Sets a trait that changes the dual-wield combo damage multiplier.
The butler's dual-wield combo damage multiplier is 100% by default.

Dual-wield combo damage multiplier:
For dual-wield combo actions set with DarkPlasma_DualWieldRepeats
This is multiplied by the damage if the butler has the dual-wield trait.

<dualWieldRepeatsDamageRate:n>
Multiplies the dual-wield combo damage multiplier by n%.

<dualWieldRepeatsDamageRatePlus:n>
Adds the dual-wield combo damage multiplier by n%.
