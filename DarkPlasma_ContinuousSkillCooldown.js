...
@plugindesc Skill cooldown continues after battle
@author DarkPlasma
@license MIT
...
version: 1.0.2
Skill cooldowns set by DarkPlasma_SkillCooldown
continue even after combat.

Adds the following information to your save data:
- Skill cooldown information for each actor
...
@text Cooldown on the map
@desc If ON, the cooldown turn count will advance when a turn passes on the map.
@type boolean
@default true
*/
