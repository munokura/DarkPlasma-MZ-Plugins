...
@plugindesc Prevent fast display of messages
@author DarkPlasma
@license MIT
...
version: 1.0.3
The plugin command allows you to disable or enable fast message display.

@command Enable showFastMessage
@text Allow fast message display

@command Disable showFastMessage
@text Prohibit high-speed message display
*/
