...
@plugindesc Highlight newly acquired items in the menu's item list
@author DarkPlasma
@license MIT
...
version: 1.2.0
Highlights newly acquired items in the menu item list.
...
@param newItemColor
@text Item color
@desc Specify the color number of the newly acquired item.
@type number
@default 2

@param newItemToTop
@text New items at the top
@desc If ON, newly acquired items will be displayed at the top.
@type boolean
@default false
*/
