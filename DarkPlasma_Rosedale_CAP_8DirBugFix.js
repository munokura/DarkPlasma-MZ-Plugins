...
@plugindesc Rosedale_CollisionAlteringPlugin 8-way walking graphics bug fix patch
@author DarkPlasma
@license MIT
...
version: 1.1.0
Fixes the following bug in the official DLC Rosedale_CollisionAlteringPlugin.

When using the 8-way walking graphics, characters do not display correctly on
save screens, etc.

This plugin is a bug fix patch for the official DLC plugin.
This plugin will be discontinued once the fix is implemented in the official
DLC itself.

This plugin adds the following information to global save data:
- Party member actor IDs for each save data
