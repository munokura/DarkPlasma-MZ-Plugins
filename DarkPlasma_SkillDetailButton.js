...
@plugindesc Skill detailed description display button
@author DarkPlasma
@license MIT
...
version: 1.0.0
Displays a button image that toggles the display of detailed skill
descriptions.
...
@text Display button image
@type file
@dir img

@param hideButtonImage
@text Hide button image
@type file
@dir img
