...
version: 1.0.1
Adds "Spread" to the range settings for skills and items.

If the range setting is "Enemy" or "Ally" and the number is "Single," enter
the following in the memo field of a skill or item to change the range setting
to "Spread."

<blastScope>

The "Spread" range specifies a single enemy and also affects enemies on either
side of it.
Note that "adjacent" here refers to the order in which the enemy was added to
the group, and does not necessarily relate to the display position.

@param damageRate
@text Damage multiplier (%)
@desc Set the damage and recovery amount multiplier for the target's neighbors.
@type number
@default 50
*/
