...
@plugindesc Setting the Master Volume
@author DarkPlasma
@license MIT
...
version: 1.0.3
Adds a master volume to the options screen.
You can adjust the volume of all BGM, BGS, ME, and SE simultaneously.

This plugin cannot be used on Game Atsumaru.
...
@param offset
@text Volume increase/decrease amount
@type number
@default 20
*/
