...
@plugindesc Item sealing feature
@author DarkPlasma
@license MIT
...
version: 2.0.1
By entering a specific tag in the memo field,
you can add a feature that makes certain items unusable.
<sealAllItem>
All items will be unusable.
<sealItems:1,2>
Items with item IDs 1 and 2 will be unusable.
<sealHealItem>
HP or MP recovery items will be unusable.
<sealResurrectionItem>
Items that have the effect of removing incapacity will be unusable.

By entering a similar tag in the map's memo field,
certain items will be unusable within the target map.
