...
@plugindesc Use all attack attributes in the calculation
@author DarkPlasma
@license MIT
...
Version: 1.0.1
If an attack has multiple attributes, all of the attack's attributes are used
in damage calculation.

The calculation method differs between Shiro-san and additive.
For example, if you use a fire + light attack on an enemy with 200% fire
effectiveness and 150% light effectiveness,
the result will be as follows:
Multiplication: 2 x 1.5 = 300%
Addition: 2 + 1.5 = 350%

Please note that in additive mode, if you use a fire + light attack on an
enemy with 100% fire effectiveness and 100% light effectiveness,
the damage will be 1 + 1 = 200%.

@param addition
@text Add or
@desc Whether to add the effectiveness of all attributes when calculating. If OFF, they will be multiplied.
@type boolean
@default false
*/
