...
@plugindesc Skills and items with multiple attributes
@author DarkPlasma
@license MIT
...
version: 1.1.1
Adds attributes to skills and items.

Write <additionalElements:(attribute name)>
in the memo field of the skill or item to which you want to add an attribute.
The attribute name is the name of the attribute specified in the type.

For example, if you want to add fire to a physical skill, write
<additionalElements:fire>

To add multiple attributes, separate them with commas.
<additionalElements:fire,ice,lightning>

If you specify a name that does not exist in the system's type,
a normal attack attribute will be added.

The attribute used for actual damage calculation
will be the most effective attribute by default in RPG Maker MZ.
If you want to use all attributes added with this plugin for damage
calculation,
consider using DarkPlasma_MultiElementRate.
*/
