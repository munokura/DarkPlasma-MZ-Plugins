// DarkPlasma_ChoiceHelp 1.0.6
// Copyright (c) 2020 DarkPlasma
// This software is released under the MIT license.
// http://opensource.org/licenses/mit-license.php

/**
 * 2021/07/05 1.0.6 MZ 1.3.2に対応
...
@plugindesc Show help for the selection
@author DarkPlasma
@license MIT
...
version: 1.0.6
You can display help text in options.

Set the help text list using the plugin command before the option event
command.

@command setChoiceHelp
@text Help text for options
@desc Sets the help text for the option.
@arg helpTexts
@text Help text list
@desc Set the help text list. Set it in the same order as the options.
