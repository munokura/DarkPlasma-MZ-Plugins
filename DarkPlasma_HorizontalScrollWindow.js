...
@plugindesc Horizontally scrolling window
@author DarkPlasma
@license MIT
...
version: 1.0.0
This plugin is intended for plugin developers.

By writing the following, you can change the scroll direction of the selected
window from vertical to horizontal.
