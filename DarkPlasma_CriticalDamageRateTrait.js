...
@plugindesc Set critical damage rate characteristics
@author DarkPlasma
@license MIT
...
version: 1.0.0
You can set a critical damage rate trait.

By adding the following to the memo field of an actor, class, skill, weapon,
armor, enemy character, or state,

it will add a trait that increases the target's critical damage rate by n%.
...
@text Default Critical Damage Rate
@desc Sets the initial critical damage rate.
@type number
@default 300
*/
