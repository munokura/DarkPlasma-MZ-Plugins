...
@plugindesc Save and view your wishlist
@author DarkPlasma
@license MIT
...
version: 1.0.0
Save and display wishlists.

This plugin saves materials needed for item synthesis and displays them as a
wishlist.

Items added to the wishlist will be removed from the wishlist once they are
obtained.

Open the wishlist display scene
SceneManager.push(Scene_WishList);

This plugin extends save data.
Wishlist information is added to the save data.

To add or remove items from the wishlist, please use an extension plugin.
DarkPlasma_WishListForFusionItem.js allows you to add and remove items from
the wishlist at the Item Fusion Shop added by DarkPlasma_FusionItem.js.

For the interface for creating extension plugins,
see the TypeScript type definitions in the master branch of the distribution
repository.

@param wishListRegisteredColor
@text Registered colors
@desc Specifies the color of the wishlisted item.
@type color
@default 24
