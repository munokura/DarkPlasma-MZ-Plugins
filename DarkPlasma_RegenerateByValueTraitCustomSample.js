...
@plugindesc HP regeneration value MP regeneration value Custom ID sample of feature
@author DarkPlasma
@license MIT
...
version: 1.0.0
This is a sample implementation of a custom ID defined with
DarkPlasma_RegenerateByValueTrait.
For custom ID: 1, this will restore HP regeneration by the value of the
variable specified by the parameter.

The sample trait is defined as follows:
<hpRegenerationValue: 0> (This 0 can be any number and will be ignored.)
