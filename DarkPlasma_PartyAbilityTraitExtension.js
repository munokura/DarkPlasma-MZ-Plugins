...
@plugindesc Add party ability features
@author DarkPlasma
@license MIT
...
Version: 1.2.3
Adds a party ability trait.
By entering the specified information in the actor/job/equipment/state memo
field,
you can grant a trait that affects the entire party.

Basic Syntax:
<partyAbility:[trait]:[data]:[value]>
Grant the trait specified by [trait] to the entire party
with trait data [data] and effect amount [value].
...
[trait]:
paramPlus: Parameter Addition
paramRate: Parameter Multiplication
xparamPlus: Additional Ability Value Addition (※1)
xparamRate: Additional Ability Value Multiplication
sparamPlus: Special Ability Value Addition
sparamRate: Special Ability Value Multiplication (※2)

[data] for param traits:
mhp: Maximum HP
mmp: Maximum MP
atk: Attack Power
def: Defense Power
...
cev: Critical Hit Evade Rate
mev: Magic Evade Rate
...
*1: Additional Ability Score Addition
Additions from party abilities are not included in the multiplication.

*2: Special Ability Value Multiplication
Multiplication by party abilities is performed after addition.

The following syntax is deprecated.
It is maintained for compatibility, but
will be discontinued in the next major version update.
<partyAbility:[effect]:[value]>
Grant the effect specified by [effect] to the entire party with an effect
amount of [value].

[effect]:
mhp: Maximum HP bonus
mmp: Maximum MP bonus
atk: Attack power bonus
def: Defense power bonus
mat: Magic attack power bonus
mdf: Magic defense power bonus
agi: Agility bonus
luk: Luck bonus

tgr: Target chance multiplier
grd: Defense effectiveness multiplier
rec: Recovery effectiveness multiplier
pha: Medicine knowledge multiplier
mcr: MP consumption rate multiplier
tcr: TP charge rate multiplier
pdr: Physical damage rate multiplier
mdr: Magic damage rate multiplier
fdr: Floor damage rate multiplier
exr: Experience gain rate multiplier
...
If using with the following plugins, add them below:
