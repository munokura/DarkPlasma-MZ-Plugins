...
@plugindesc Arrange the equipment
@author DarkPlasma
@license MIT
...
version: 1.1.0
When selecting equipment on the equipment screen,
the player can perform certain actions to align their equipment.
...
@text Selected color
@desc Sets the display color of the selected alignment parameter.
@type color
@default 2
