...
@plugindesc Expanding skill cost display
@author DarkPlasma
@license MIT
...
version: 1.1.3
Displays the extended skill costs set with DarkPlasma_SkillCostExtension
in the skill list.

Displays only one cost for the target skill in the following order of
priority:
Variables > Money > Items > HP > TP > MP
...
@param hpCostColor
@text HP cost color
@desc Specify the HP cost color using the Maker color number or #+6 hexadecimal number.
@type color
@default 2

@param itemCostColor
@text Item Cost Color
@desc Specify the color of the item cost using the Maker color number or #+6 digit hexadecimal number.
@type color
@default 0

@param goldCostColor
@text Money Cost Color
@desc Specify the color of the money cost using the Tsukur color number or #+6 digit hexadecimal number.
@type color
@default 6

@param variableCostColor
@text Variable Cost Color
@desc Specify the color of the variable cost using the Maker color number or #+6 digit hexadecimal number.
@type color
@default 5
*/
