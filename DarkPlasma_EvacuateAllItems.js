...
@plugindesc Plugin command to evacuate items
@author DarkPlasma
@license MIT
...
version: 1.0.0
Provides a plugin command to temporarily store items you own.
Stored items will disappear from your inventory.
You can return them to your inventory using the restore command.

This plugin extends your save data.
The IDs and number of stored items will be included in the save data.

@command EvacuateAllItems
@text Evacuate items
@desc Temporarily remove all items you have.
@arg evacuateItems
@text Evacuate items
@desc Evacuate items. Don't evacuate anything important.
@type boolean
@default true

@arg evacuateWeapons
@text Draw back your weapon
@desc This will unload your weapon. Your equipped weapon will not be unloaded.
@type boolean
@default false

@arg evacuateArmors
@text Evacuate the armor
@desc Evacuate your armor. Equipped armor will not be evacuated.
@type boolean
@default false

@arg evacuateKeyItems
@text Evacuate important things
@desc Evacuate important things.
@type boolean
@default false

@command RegainItems
@text Returning evacuated items
@desc Return the items you have evacuated. Items that exceed the limit will be discarded.
*/
