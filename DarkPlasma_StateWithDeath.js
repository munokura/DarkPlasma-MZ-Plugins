...
@plugindesc A state that does not disappear even if you are unable to fight
@author DarkPlasma
@license MIT
...
version: 1.1.0
The specified state will not be canceled even if you are incapacitated.

@param statesWithDeath
@text Persistent states
@type state[]
@default []
*/
