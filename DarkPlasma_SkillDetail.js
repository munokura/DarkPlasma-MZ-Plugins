...
@plugindesc Adding a detailed description to your skill
@author DarkPlasma
@license MIT
...
version: 2.0.1
Hover the cursor over a skill in the Skills window and press a specific button
to open the skill details screen.

You can enter a detailed description in the skill's memo field using the
following:
