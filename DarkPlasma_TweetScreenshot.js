...
@plugindesc Tweet a screenshot of the game
@author DarkPlasma
@license MIT
...
Version: 2.1.0
Anonymously upload a screenshot of your game to imgur,
and open a tweet with the URL.

To use this app, you must register with imgur and obtain a client ID.

This app does not support browser play.

@param clientId
@text imgur client ID
@desc Please set the client ID to use the imgur upload API.
@type string
