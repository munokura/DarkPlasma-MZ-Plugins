...
@plugindesc Item Scene Command to equip from item list
@author DarkPlasma
@license MIT
...
version: 1.0.0
When you hover the cursor over an item in the item scene and press Confirm,
the equip command will be displayed.
