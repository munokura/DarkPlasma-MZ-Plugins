...
@plugindesc Change the battle background during battle
@author DarkPlasma
@license MIT
...
version: 1.0.0
Provides a plugin command to change the battle background during battle.

@command changeBattleback
@text Change the battle background
@arg back1
@text background 1
@type file
