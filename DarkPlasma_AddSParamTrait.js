...
@plugindesc Features that add special ability scores
@author DarkPlasma
@license MIT
...
Version: 2.0.0
By entering the specified information in the memo field for an actor, job,
equipment, enemy character, or state,
you can add a feature that increases special ability values.
This setting value will be added after applying any multiplier features you
can specify in the editor.

Example:
MP Consumption Rate +10%
<addSParam:mcr:10>

Physical Damage Rate -10%
<addSParam:pdr:-10>

Physical Damage Rate -10%, Magic Damage Rate -10%
<addSParam:
pdr:-10
mdr:-10
>
...
If using with the plugins below, add this above them.
