...
@plugindesc Display footprint images and play footstep sounds
@author DarkPlasma
@license MIT
...
Version: 1.0.2
Displays footprint images and plays footstep sounds depending on the tileset
settings.

Set footprint images and footstep sounds for each terrain tag in the memo
field for the tileset.

Example settings:
<Step Effect 1: Footprint>
<Step Effect Settings 1: 0, 12, fitAngle, fitStep, animeSpeed 16>
<Step Sound 1: sand>
<Step Sound Settings 1: 30-50, 130>

Tileset memo tag settings are compatible with Yana's StepEffect.js.

@param cellWidth
@text Footprint cell width
@type number
@default 48

@param animationSpeed
@text Footprint playback speed
@type number
@default 8

@param stepOffset
@text Offset from center
@desc The footprint image will be displayed offset from the center of the map square by half the set value.
@type number
@default 8

@param audioDistance
@text Footstep Distance
@desc Sets the distance at which footsteps other than the player's can be heard.
@type number
@default 10

@param excludeEventTag
@text Exclude Event Tags
@desc Events with one or more of these notetags set will not display footprints or play footstep sounds.
@type string[]
@default []
*/
