...
@plugindesc Realize fixed equipment mode
@author DarkPlasma
@license MIT
...
Version: 1.0.2
Implements a fixed equipment mode.

Register a pair of a switch and a list of equipment types in the plugin
parameters.
When a registered switch is turned ON, the corresponding equipment type cannot
be changed.

@param fixEquips
@text Fixed equipment settings
@desc Set a pair of switch and equipment type list.
