// DarkPlasma_FilterEquip_RecentlyGained 1.0.2
...
@plugindesc Filter recently acquired equipment
@author DarkPlasma
@license MIT
...
version: 1.0.2
Adds "Recently Acquired Equipment" to the equipment filtering provided by
...
@param threshold
@text Record number of equipment acquired
@desc The equipment acquisition history will be recorded for this number of items, and the equipment included in this history will be treated as recently acquired equipment.
@type number
@default 5
@min 1
...
(() => {
  ...
  Scene_Equip.prototype.equipFilterBuilder = function (equips) {
    ...
    traitIds[ALLOCATION_TRAIT_ID_RECENTLY_GAINED] = uniqueTraitIdCache.allocate(
      pluginName,
