...
@plugindesc Damage falloff for ranged and continuous attacks
@author DarkPlasma
@license MIT
...
version: 1.0.3
Adding <multiAttack> to a skill's memo field will decrease damage during area
or multi-attack attacks.

For area attacks, if the decrease rate is 10%,
the damage dealt will decrease by 100% to the first enemy, 90% to the second,
80% to the third, and so on.

This damage decrease is not taken into account when evaluating actions during
default auto-combat.

@param fallRate
@text Attenuation rate (%)
@desc Damage falloff rate for each attack target
@type number
@default 10

@param minimumRate
@text Minimum damage rate (%)
@desc Minimum damage rate at which decay will occur
@type number
@default 10
*/
