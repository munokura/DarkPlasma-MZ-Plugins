...
@plugindesc Change the damage multiplier depending on the vanguard actor's position
@author DarkPlasma
@license MIT
...
Version: 1.0.6
Changes the damage multiplier depending on the vanguard actor's position
(number from the front).

@param physicalDamageRates
@text Physical damage multiplier (%)
@desc Physical damage multiplier. Corresponds to the formation position from the front. If no value is specified, it will be 100. If no value is specified after that, it will be the last value specified.
@type number[]
@default ["100"]

@param magicalDamageRates
@text Magic damage multiplier (%)
@desc Magic damage multiplier. Corresponds to the formation position, starting from the front. If no value is specified, it will be 100. If no value is specified after that, it will be the last value specified.
@type number[]
@default ["100"]
*/
