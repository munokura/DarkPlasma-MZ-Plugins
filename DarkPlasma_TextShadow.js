...
@plugindesc Adding shadow to text
@author DarkPlasma
@license MIT
...
version: 1.0.0
Adds a shadow to text using control characters.

\SHADOW[setting ID]
Enter the setting ID set in the plugin parameters.
Set this to 0 to disable shadow rendering.

@param shadows
@text Shadow settings list
@type struct<Shadow>[]
*/
