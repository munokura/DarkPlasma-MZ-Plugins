...
@plugindesc Display a message window in the specified scene
@author DarkPlasma
@license MIT
...
version: 1.0.3
You can now display a message window in the scene specified by the parameter.

When you add a message using $gameMessage.add,
the message will also be displayed in that scene.
