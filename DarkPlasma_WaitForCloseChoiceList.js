...
@plugindesc Wait for the choice window to close when changing scenes
@author DarkPlasma
@license MIT
...
version: 1.0.3
In RPG Maker MZ, when a choice window has many options,
remnants of the choice window remain behind the new scene window.

This plugin prevents a new scene window from opening before the choice window
