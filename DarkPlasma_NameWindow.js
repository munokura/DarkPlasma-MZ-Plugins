...
@plugindesc Show name window during conversation events
@author DarkPlasma
@license MIT
...
version: 2.0.5
The following message text will display the name window.

\n<***>

Also, the following will display the actor name corresponding to the ID in the
name window.
...
@desc Name window default text color
@type color
@default 6

@param actorColors
@text Actor Color Settings
@desc Set the name color for each actor
@type struct<ActorColor>[]
@default []

@param autoNameWindow
@text Auto Name Window
@desc Detect " and ( and automatically display the name window
@type boolean
@default false

@param forceAutoNameColor
@text Automatic name color enforcement
@desc Fix the color of automatically detected names to the settings of this plugin (ignore conversions by DarkPlasma_AutoHighlight, etc.)
@type boolean
@default true
*/
