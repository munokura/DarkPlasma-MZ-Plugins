...
@plugindesc HP regeneration value MP regeneration value characteristics
@author DarkPlasma
@license MIT
...
version: 1.0.0
Defines the HP regeneration value and MP regeneration value traits.
Unlike regeneration rates, regeneration value traits are not a percentage of
HP or MP caps, but rather determine recovery and slip damage as turns pass.

Example:
<hpRegenerationValue:10>
Adds a trait that restores 10 HP per turn.

<mpRegenerationValue:-10>
Adds a trait that consumes 10 MP per turn.

If you want to dynamically vary the recovery amount from the trait,
define a custom ID and write an additional plugin.

<hpRegenerationCustomId:1>
<mpRegenerationCustomId:1>

For an example of how to write an additional plugin, see
