...
@plugindesc State to swap parameters
@author DarkPlasma
@license MIT
...
version: 1.0.0
This creates a parameter swap state.

Entering <swapParam:atk,mat> in the state's memo field will swap attack power
and magic power while the state is active.
...
States that swap the same parameter cannot be duplicated.
*/
