...
@plugindesc Display detailed equipment descriptions in equipment scenes
@author DarkPlasma
@license MIT
...
version: 1.0.2
Hovering the cursor over equipment in the equipment scene and pressing a
specific button
opens the equipment details window.

You can enter a detailed description in the equipment's memo field using the
following:
...
@desc Sets the button to open the detailed description.
@type select
@default shift
@option pageup
@option pagedown
