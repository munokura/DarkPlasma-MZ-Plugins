...
@plugindesc Set the item selling price multiplier
@author DarkPlasma
@license MIT
...
version: 1.0.2
Sets the multiplier for selling items.

@param sellingPriceRate
@text Sales price ratio (%)
@desc Set the percentage of the item sale rate.
@type number
@default 50
@min 1
*/
