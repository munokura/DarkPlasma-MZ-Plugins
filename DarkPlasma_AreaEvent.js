...
@plugindesc Expand the event hit detection area
@author DarkPlasma
@license MIT
...
version: 1.0.4
Expands the collision detection area for events with the <areaEvent> meta tag.
The area is set using the plugin command at the top of the page.

@command registerArea
@text Area Settings
@desc This command will expand the collision detection of the page on which it is placed.
@arg width
@text Width
@type number
@default 1
...
@arg origin
@desc Sets the location of the event to be set in the editor.
@type select
@default 7
@option upper left
@value 7
