...
@plugindesc Status bonus characteristics by equipment type
@author DarkPlasma
@license MIT
...
version: 2.3.1
By entering notetags in the specified format in the memo field of an
actor/class/weapon/armor/state, you can add stat bonus features that become
active when equipped with a specific weapon or armor type.

Stat bonuses available when equipped with a specific weapon type.
<weaponTypeBonus:[weaponType]:[statusType]:[value]>
Status bonuses available when equipped with a specific armor type.
...
luk: Luck bonus
hit: Hit rate bonus
eva: Evade rate bonus
cri: Critical hit rate bonus
cev: Critical hit evasion rate bonus
mev: Magic evade rate bonus
mrf: Magic reflection rate bonus
cnt: Counterattack rate bonus
hrg: HP regeneration rate bonus
mrg: MP regeneration rate bonus
trg: TP regeneration rate bonus

Example: +5% hit rate when equipped with an axe weapon type
<weaponTypeBonus:axe:hit:5>

Example: +10 defense and +5% dodge rate when equipped with a shield armor type
<armorTypeBonus:
shield:def:10
shield:eva:5
>
