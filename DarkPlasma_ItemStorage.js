...
version: 1.7.0
Provides an item storage scene.
You can open the storage using the plugin command.

@param maxItems
@text Maximum number by item
@desc Sets the maximum number of each type of item that can be stored in the warehouse.
@type number
@default 99
...
@arg item
@text Item Display
@desc Show items in categories
@type boolean
@default true

@arg weapon
@text weapon display
@desc Show weapons in categories
@type boolean
@default true

@arg armor
@text Armor display
@desc Show armor in categories
@type boolean
@default true

@arg keyItem
@text Show important things
@desc Show what's important in categories
@type boolean
@default false

@command storeAll
@text Keep as much as possible
@desc Store as many of your items as possible in the warehouse.
@arg item
@text Deposit an item
@type boolean

@arg weapon
@text Deposit weapons
@type boolean

@arg armor
@text Deposit your armor
@type boolean

@arg keyItem
@text Keep important items
@type boolean

@command fetchAll
@text Pull out as much as possible
@desc Remove as many items from your storage as possible.
@arg item
@text Pull out an item
@type boolean
...
@arg armor
@text Pull out the armor
@type boolean

@arg keyItem
@text Bring out what's important
@type boolean
*/
