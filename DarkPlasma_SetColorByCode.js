...
@plugindesc Specify colors using control characters with color codes beginning with #.
@author DarkPlasma
@license MIT
...
version: 1.0.2
Allows you to specify colors using the control character \C with a color code
beginning with #.

Example: \C[#adff2f]
This will result in a yellow-green color.
*/
