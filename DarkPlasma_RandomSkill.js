...
@plugindesc Use effect: Activate one of the specified skills.
@author DarkPlasma
@license MIT
...
version: 1.0.0
When used, this effect activates one of the randomly selected skills.

If you write the following in the memo field of a skill or item,
skill ID 5 will be activated 2/3 of the time, and skill ID 6 will be activated
1/3 of the time.
...
The target of the skill or item with this effect should be set to the user.
