...
@plugindesc Prioritized State Groups
@author DarkPlasma
@license MIT
...
Classifies states into priority groups.
States belonging to the same priority group cannot be stacked.
...
Set the priority within the group to y.
The higher the number, the higher the priority.
If the stateGroup memo tag is not specified, this memo tag has no effect.
If the stateGroup memo tag is specified but this memo tag is not specified,
it will not belong to a priority group.
If multiple states have the same priority,
the later state will overwrite the previous one.
