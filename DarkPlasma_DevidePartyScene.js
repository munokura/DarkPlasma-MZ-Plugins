...
version: 1.1.1
Provides a scene for splitting parties.

This plugin requires the following plugins:
DarkPlasma_ConcurrentParty version: 1.2.0
DarkPlasma_SelectActorCharacterWindow version: 1.1.0
If using this plugin with the following plugins, add it below them:
...
@param helpText
@text help
@desc Sets the text to display in the help window.
@type multiline_string

@command open
@text Open the party split scene
@arg count
@text Number of parties
@desc Number of parties after splitting
@type number
@default 2
@min 2
@max 3
...
@arg locations
@text Initial position list
@desc Specify the initial location list for each party.
@type location[]
*/
