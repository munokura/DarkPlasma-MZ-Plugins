...
@plugindesc Force combat action by specifying the subject and target ID.
@author DarkPlasma
@license MIT
...
version: 1.0.0
Provides a plugin command that forces combat actions by specifying the subject
and target IDs.

If the subject does not exist, the plugin command does nothing.
If the target does not exist, a target is selected randomly.

@command forceActionEnemyToActor
@text Forced combat actions (from enemy characters to actors)
@arg subject
@text Actors
@desc Sets the subject of action. If none, all enemies will act.
@type enemy
...
@arg target
@text subject
@desc Set the target. If None, a random target will be selected.
@type actor

@command forceActionActorToEnemy
@text Forced combat actions (from actor to enemy character)
@arg subject
@text Actors
@desc Set the subject of action. If none, all allies will act.
@type actor
...
@text Forced combat actions (enemy character to enemy character)
@arg subject
@text Actors
@desc Set the action subject. If none, all enemies will act.
@type enemy
...
@text Combat Mandate (Actor to Actor)
@arg subject
@text Actors
@desc Set the subject of action. If none, all allies will act.
@type actor
