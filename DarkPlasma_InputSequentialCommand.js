...
@plugindesc A series of command inputs
@author DarkPlasma
@license MIT
...
version: 1.1.0
Allows you to check a sequence of command inputs.

Input.clearBuffer(): void
Initializes the command input buffer.

Input.isSequentialInputted(command: string[]): boolean
Determines whether a command sequence has been input last.

@param bufferSize
@text Command Buffer Size
@desc Specifies the size of the command buffer to be remembered.
@type number
@default 10
*/
