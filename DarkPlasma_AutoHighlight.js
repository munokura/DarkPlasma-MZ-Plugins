...
@plugindesc Automatically color specified words
@author DarkPlasma
@license MIT
...
version: 2.0.2
Highlights the specified phrase in the specified color.

This plugin requires the following plugin:
DarkPlasma_SetColorByCode version: 1.0.0

@param highlightGroups
@text Colors and phrases
@desc Set the color and phrase to highlight.
@type struct<HighlightGroup>[]
@default []

@param targetWindows
@text Target window
@desc Specifies the window class that will be auto-highlighted.
@type string[]
