...
@plugindesc Rewrite skill/item display order ID
@author DarkPlasma
@license MIT
...
version: 1.1.4
If the order of items or skills is by ID, enter the following in the memo
field.
The numeric value will be used instead of the ID.

For skills, the OrderId tag is only valid if the plugin parameters specify ID
order.

<OrderId:xxx> xxx is an integer value

@param sortSkillById
@text Skill ID order
@desc Skills are displayed in ID order.
@type boolean
@default false
*/
