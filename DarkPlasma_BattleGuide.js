...
@plugindesc Display combat guide
@author DarkPlasma
@license MIT
...
Version: 1.3.1
You can display a manual during battle.

Some SceneGlossary tags are supported.
- SG Description
- SG Visible Switch
- SG Picture
- SG Picture X
...
@param listWidth
@text Table of contents width
@desc Sets the width of the manual table of contents window.
@type number
@default 240

@param fontSize
@text Font size
@desc Sets the font size for the manual.
@type number
@default 22

@param showPageNumber
@text Page Number Display
@desc Sets the page number display strategy.
@type select
@default 0
@option default (displayed if there are two or more pages)
@value 0
@option always (always displayed)
@value 1
@option no (no display)
@value 2

@param key
@text Key to open the manual
@type select
@option pageup
@option pagedown
@option shift
