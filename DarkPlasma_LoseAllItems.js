...
@plugindesc Plugin command to discard all items you own
@author DarkPlasma
@license MIT
...
version: 1.0.0
Provides a plugin command to discard all items you own.

@command LoseAllItems
@text Discard an item
@desc Discards all items belonging to the specified category.
@arg loseItems
@text Discard an item
@desc Discard items. Don't discard anything important.
@type boolean
@default true

@arg loseWeapons
@text Discard the weapon
@desc Discards the weapon. Does not discard the equipped weapon.
@type boolean
@default false

@arg loseArmors
@text Discard the armor
@desc Discards armor. Armor that is currently equipped will not be discarded.
@type boolean
@default false

@arg loseKeyItems
@text Discard something important
@desc Discard important things.
@type boolean
@default false
*/
