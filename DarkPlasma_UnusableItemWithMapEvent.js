...
@plugindesc Items that cannot be used during map events
@author DarkPlasma
@license MIT
...
version: 1.0.1
Items and skills with the following description in the memo field will
be unusable during a map event.
