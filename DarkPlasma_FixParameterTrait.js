...
@plugindesc Features that fix ability scores
@author DarkPlasma
@license MIT
...
Version: 1.0.2
By entering the specified description in the memo field of an
actor/job/equipment/state,
you can apply a feature that fixes stat values.
The behavior of applying multiple fixed value features to the same parameter
is undefined.
This feature applies regardless of any increases or decreases in stat values
caused by other equipment or features.

Basic Syntax:
<fixParameter:[effect]:[value]>
Fixes the parameter specified by [effect] to [value].
[value] can be a half-width number or the \V[x] notation. (Nesting is not
allowed)
