...
@plugindesc View the detailed description of the item
@author DarkPlasma
@license MIT
...
version: 1.0.5
Hover the cursor over an item on the item screen and press a specific button
to open the item details screen.

You can enter a detailed description in the item's memo field using the
following:
...
@param openDetailKey
@text Detailed explanation button
@desc Button to open detailed description
@type select
@default shift
@option pageup
@option pagedown
...
@text Detailed Height Correction
@desc Height compensation for detail window content.
@type number
@default 32
*/
