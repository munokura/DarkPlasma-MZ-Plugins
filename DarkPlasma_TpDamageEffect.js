...
@plugindesc Use effect that damages TP
@author DarkPlasma
@license MIT
...
version: 1.0.0
Adds a usage effect that deals damage to TP.

By entering the following in the memo field of a skill or item,
you can set the usage effect to deal 10 damage to TP.
<tpDamage:10>

If you want to set the effect to deal damage other than a fixed amount,
please create an extension plugin.
