...
version: 2.2.0
Provides a fusion shop that converts multiple items, weapons, armor, and money
into a single item.

Register a preset inventory in the plugin parameters,
and specify the preset ID in the plugin command.

If using with the following plugins, add this plugin above them:
DarkPlasma_Scene_MessageMixIn

@param presets
@text Assortment Preset
@type struct<FusionGoods>[]
@default []

@param useEquip
@text Use what you have equipped
@desc If ON, the fusion material equipped will be used.
@type boolean
@default false

@param commandName
@text Fusion Command Name
@desc Command name displayed when opening the shop
@type string
@default 融合する

@command fusionShop
@text Open a Fusion Shop
@arg presetIds
@text Preset ID List
@desc Specify the preset ID set in the plug-in parameters. If multiple IDs are specified, they will be merged.
@type number[]
*/
