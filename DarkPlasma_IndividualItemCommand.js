...
@plugindesc Item Scene: Display commands for individual items
@author DarkPlasma
@license MIT
...
version: 1.1.1
When you hover the cursor over an item during an item scene and press Confirm,
the individual command will be displayed.
*/
