...
@plugindesc A window base that displays detailed descriptions of database items.
@author DarkPlasma
@license MIT
...
version: 1.0.1
Provides a basis for displaying detailed descriptions of database items in a
window.
