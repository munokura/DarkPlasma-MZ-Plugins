// DarkPlasma_DisplayHpMpDamage 1.0.3
...
@plugindesc Pop-ups for damage/recovery for both HP and MP
@author DarkPlasma
@license MIT
...
version: 1.0.3
If both HP and MP are damaged or recovered,
both will be displayed in a popup.

@param delay
@text Display time difference
@desc How many frames to delay the display of MP from the display of HP
@type number
@default 10

@param offsetX
@text Horizontal Offset
@desc How far to shift the MP display from the HP display
@type number
@default 8

@param offsetY
@text Vertical Offset
@desc How much to vertically shift the MP display from the HP display
@type number
@default -16
@min -300
*/
