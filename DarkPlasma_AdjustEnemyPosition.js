...
@plugindesc Move enemy coordinates to match UI area size
@author DarkPlasma
@license MIT
...
version: 1.0.2
Moves enemy placement to fit the UI area size.

This feature was officially added in MZ 1.3.0.
This plugin is only valid for earlier versions.
*/
