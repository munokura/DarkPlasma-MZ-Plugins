...
@plugindesc Whether to remove buffs and debuffs at the end of battle
@author DarkPlasma
@license MIT
...
version: 1.0.0
This setting determines whether buffs and debuffs for all battlers are removed
at the end of battle.

By default, buffs and debuffs for actors who leave battle by fleeing are not
removed at the end of battle.
This plugin determines whether buffs and debuffs for all battlers, including
those who flee, are removed.

@param removeBuffAtBattleEnd
@text Removes buffs and debuffs at the end of battle
@desc At the end of the battle, all buffs and debuffs on all battlers, including those who fled, will be removed.
@type boolean
@default true
*/
