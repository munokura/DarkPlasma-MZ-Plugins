...
@plugindesc Actions that make a defeated opponent unable to revive
@author DarkPlasma
@license MIT
...
Version: 1.0.2
When an enemy is defeated with a skill or item that has the following notetag,
the target will become immortal.

<severImmortality>

Resurrection occurs when an enemy that has been incapacitated returns to
battle through one of the following reasons:
- Recovering with an HP recovery skill
- Removing the incapacity state with an action that removes it
- Recovering with the event command "Fully Recover Enemy Character"
- Removing the incapacity state with the event command "Change Enemy
Character's State"
*/
