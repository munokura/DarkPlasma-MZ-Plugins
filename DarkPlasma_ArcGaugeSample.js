...
@plugindesc Arc-shaped gauge sample implementation
@author DarkPlasma
@license MIT
...
version: 1.0.0
This is a sample implementation of an arc-shaped gauge.
It changes the status screen gauge to an arc shape.
*/
