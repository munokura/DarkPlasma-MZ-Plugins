...
@plugindesc Change sprint speed
@author DarkPlasma
@license MIT
...
version: 1.0.5
Changes sprint speed.

This plugin adds the player's sprint speed to your save data.

@param defaultDashSpeed
@text Default Sprint Speed
@desc Default sprint speed. Higher is faster.
@type number
@default 1
@decimals 1

@command changeDashSpeed
@text Dash speed change
@desc Changes sprint speed.
@arg dashSpeed
@text Sprint Speed
@type number
@default 1
